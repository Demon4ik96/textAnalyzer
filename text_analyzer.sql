...
--
-- Host: localhost    Database: text_analyzer
-- ------------------------------------------------------
...
CREATE TABLE `analyze_result` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_analyze_result_input_idx` (`input_id`),
  CONSTRAINT `fk_analyze_result_input` FOREIGN KEY (`input_id`) REFERENCES `input` (`input_id`) ON DELETE CASCADE
...
-- Dump completed on 2021-07-14  2:25:25
